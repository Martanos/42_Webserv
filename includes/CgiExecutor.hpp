...
public:
    ...
    ExecutionResult execute(const std::string &scriptPath,
...
private:
    ...
    void closePipes();
    ExecutionResult forkAndExec(const std::string &scriptPath,
                               const std::string &interpreter,
                               char **envp);
    ExecutionResult communicateWithChild(const std::string &inputData,
                                        std::string &outputData,
                                        std::string &errorData);
